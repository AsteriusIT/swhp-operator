...
[![Helm Chart](https://img.shields.io/badge/helm%20chart-v0.1.0-blue)](https://github.com/AsteriusIT/swhp-operator/releases/tag/v0.1.0)
...
1. Install the SWHP Operator Helm chart:
   ```bash
   helm install swhp-operator oci://rg.fr-par.scw.cloud/asterius-public-helm/operators/swhp-operator --version 0.1.0
   ```
